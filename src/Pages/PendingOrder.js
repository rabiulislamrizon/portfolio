...
const PendingOrder = () => {
    ...
    return (
        <>
            ...
            <section id="services" className="services-area  pb-90 fix mb-5">
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                {order.paymentStatus === 'UnPaid' && (
                                                    <Link className='rr-btn rr-btn__theme-4 mb-5' to={`/pay-now/${order._id}`}>Pay Now</Link>
                                                )}
                                                {order.paymentStatus === 'Paid' && (
                                                    <Link className='rr-btn rr-btn__theme-4 mb-5' to='#'>You Have Paid</Link>
                                                )}
                                            </td>
                                        </tr>
                                    ))}
