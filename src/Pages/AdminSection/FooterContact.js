                                ...
                                <>
                                    {
                                        footeraddress.map(c =>
                                            footeraddress.map(c =>
                                                <Link className='rr-btn rr-btn__theme-4 mb-5' to={`/edit-address-footer/${c._id}`}> Edit Address</Link>)
                                ...
                                <form class="contact-form " onSubmit={handlefooterAddress}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="rr-btn rr-btn__theme-4 mb-5" data-delay=".8s"> Add Office Address</button>
                                        </div>
                                    </div>
