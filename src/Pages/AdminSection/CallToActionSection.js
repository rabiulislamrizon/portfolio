                                    ...
                                    <>
                                        {
                                            ...
                                            action.map(c =>
                                                <Link className='rr-btn rr-btn__theme-4 mb-5' to={`/edit-call/${c._id}`}> Edit Call To Action</Link>)
                                    ...
                                    <form class="contact-form " onSubmit={handleActionSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn mb-3">
                                                <button class="rr-btn rr-btn__theme-4 mb-5" data-animation="fadeInRight" data-delay=".8s">Add Call To Action</button>
                                            </div>
                                        </div>
