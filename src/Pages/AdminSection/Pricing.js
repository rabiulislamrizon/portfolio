...
const Pricing = () => {
    ...
    return (
        ...
        <HeaderBottom></HeaderBottom>
            <div>
                <section id="services" class="services-area  pb-90 fix mt-5" >
                    <div class="container">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <h2>Edit Your Pricing Package</h2>
                                ...
                                {/* <form class="contact-form " onSubmit={handlePricing}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="rr-btn rr-btn__theme-4 mb-5" data-delay=".8s"> Add Package</button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="pricingTable">
                                        ...
                                        <div class="pricingTable-signup">
                                            <Link to={`/package-edit/${pri._id}`} className='rr-btn rr-btn__theme-4 mb-5'>Edit Pricing</Link>
                                        </div>
                                    </div>
                                </div>
                            )}
