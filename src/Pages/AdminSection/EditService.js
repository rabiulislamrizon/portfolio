...
const EditService = () => {
    ...
    return (
        ...
        <HeaderBottom></HeaderBottom>
            ...
            <div className='container mt-5 mb-100 d-flex align-items-center justify-content-center'>
                <form class="contact-form" onSubmit={handleAddItem}>
                    <div class="row">
                        ...
                        <div class="slider-btn">
                            <button class="rr-btn rr-btn__theme-4 mb-5" data-animation="fadeInRight" data-delay=".8s"> Update service </button>
                        </div>
                    </div>
