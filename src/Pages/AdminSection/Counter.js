                                ...
                                <>
                                    {
                                        countersec.map(c =>
                                            countersec.map(c=>
                                                <Link className='rr-btn rr-btn__theme-4 mb-5' to={`/counters/${c._id}`}> Update Counter</Link>)
                                        )
                                    }
                                </>
                            }
                                ...
                                <form class="contact-form " onSubmit={handleCounterSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="rr-btn rr-btn__theme-4 mb-5" data-animation="fadeInRight" data-delay=".8s">Update Counter</button>
                                        </div>
                                    </div>
