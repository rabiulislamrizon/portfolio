                                ...
                                <>
                                    {
                                        footersocial.map(c =>
                                            footersocial.map(c =>
                                                <Link className='rr-btn rr-btn__theme-4 mb-5' to={`/edit-social-footer/${c._id}`}> Edit Social URL </Link>)
                                ...
                                <form class="contact-form " onSubmit={handleFootersocial}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="rr-btn rr-btn__theme-4 mb-5" data-delay=".8s"> Add Footer Social </button>
                                        </div>
                                    </div>
