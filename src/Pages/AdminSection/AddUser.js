                        ...
                        <div class="col-lg-8 col-md-12">
...

                            {
                                ...
                                <>
                                            ...
                                            {users.map(a =>
                                                <Link className='rr-btn rr-btn__theme-4 mb-5' to={`/admin-user/${a._id}`}> Update User</Link>)}
                                ...
                                <form class="contact-form " onSubmit={handleUser}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn ">
                                            <button class="rr-btn rr-btn__theme-4 mb-5" data-animation="fadeInRight" data-delay=".8s"> Add User </button>
