...
const ServicesSection = () => {
    ...
    return (
        <>
            ...
            <section id="services" class="services-area  pb-90 fix mb-5" >
                <div class="container">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <h2 className='mt-5'> Update Service Text </h2>
                            {
                                service.length === 1 &&
                                <> {
                                    service.map(s => <Link className='rr-btn rr-btn__theme-4 mb-5' to={`/servicetext-edit/${s._id}`}>Update Service</Link>)
                                }</>
                                ...
                                <form class="contact-form " onSubmit={handleServiceSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="rr-btn rr-btn__theme-4 mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Services </button>
                                        </div>
                                    </div>
                            ...
                            {/* <form class="contact-form" onSubmit={handleAddItem}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="rr-btn rr-btn__theme-4 mb-5" data-animation="fadeInRight" data-delay=".8s"> Add Service </button>
                                    </div>
                                </div>
                                        ...
                                        <div className="item_content">
                                            ...
                                            <h3 className="item_title">
                                                <a href="course_details.html">
                                                    ...
                                                    <Link to={`/service-edit/${s._id}`} className='rr-btn rr-btn__theme-4 mb-5  mt-2 mb-2'>Edit Services</Link>
                                                </a>
                                            </h3>
