                ...
                <div className='text-center'> {/* Center-align the content */}
                    ...
                    <form onSubmit={handlePaymentStatus} className="text-center"> {/* Center-align the form */}
                        ...
                        <div class="slider-btn">
                            <button class="rr-btn rr-btn__theme-4 mb-5 mt-2" data-animation="fadeInRight" data-delay=".8s"> Update Payment </button>
                        </div>
                    </form>
                    ...
                    <form onSubmit={handleOrderStatus} className="text-center"> {/* Center-align the form */}
                        ...
                        <div class="slider-btn">
                            <button class="rr-btn rr-btn__theme-4 mb-5 mt-2" data-animation="fadeInRight" data-delay=".8s"> Update Order </button>
                        </div>
                    </form>
