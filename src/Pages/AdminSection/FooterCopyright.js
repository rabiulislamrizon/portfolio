                                ...
                                <>
                                    {
                                        footercopyright.map(c =>
                                            footercopyright.map(c =>
                                                <Link className='rr-btn rr-btn__theme-4 mb-5' to={`/edit-copyright/${c._id}`}> Please Edit About Footer</Link>)
                                ...
                                <form class="contact-form " onSubmit={handleFooterCopyright}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="rr-btn rr-btn__theme-4 mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Footer Copyright</button>
                                        </div>
                                    </div>
